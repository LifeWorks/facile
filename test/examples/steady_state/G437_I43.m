function [t1, y]= G437_I43(tv, initialvalues, rateconstants)

[t1, y, intervals]= G437_I43_ode_event(@G437_I43_odes, [0 0 0 0 0 0 0], [], tv, initialvalues, odeset('InitialStep', 1e-8, 'AbsTol', 1e-9, 'RelTol', 1e-3, 'MaxStep', 10.0), rateconstants);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function dydt = G437_I43_odes(t, y, rateconstants)
